...
import com.nuevo.gameness.databinding.FragmentTournamentRoomFixtureBinding
...
@AndroidEntryPoint
class TournamentRoomFixtureFragment : BaseFragment<FragmentTournamentRoomFixtureBinding>() {

    private val viewModel by viewModels<TournamentRoomFixtureViewModel>()
    ...
    override fun getViewBinding() = FragmentTournamentRoomFixtureBinding.inflate(layoutInflater)
                ...
                is NetworkResult.Success -> {
                    if (state.data.success == true) {
                        ...
                        tournamentFixtureSectionAdapter = TournamentFixtureSectionAdapter(
                            ...
                            state.data.data?.tournamentType
                        )
                        binding.recyclerViewTournamentRoomFixture.adapter = tournamentFixtureSectionAdapter
